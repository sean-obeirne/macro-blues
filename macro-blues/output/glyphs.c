...
/* Classic Adafruit 5x7 fixed-space font (glcdfont.c).
 * Flat array: 5 bytes per character, indexed as &font[c * 5].
 * Starts at ASCII 0x00; printable range begins at 0x20 (space). */
// clang-format off
