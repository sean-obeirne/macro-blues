 ...
 *
 * Stores one BLE bond (LTK + peer identity) in the last page of
 * internal flash (0x7F000).  The nRF52832's flash can be written via
 * the SoftDevice's sd_flash_* API, which handles the timing constraints
 * and coexistence with radio activity.
 *
